<template>
	<div class="pg-container">
		...
		<section class="section-wrapper flex-wrap space-x-2">
			<div class="contact">
				<div class="space-y-2" v-for="(items, index) in info.contact" :key="index">
					<div class="contact-item">
						<li class="name wow animate__animated animate__fadeInUp">{{ items.name }}</li>
						<li class="txt wow animate__animated animate__fadeInUp">{{ items.txt }}</li>
					</div>
				</div>
				<div class="wx-info flex space-x-40 ">
					<div class="flex flex-col justify-between">
						<li class="wow animate__animated animate__fadeInUp">{{ info.wx.name }}</li>
						<img class="wow animate__animated animate__fadeInUp" :src="info.wx.img" alt="">
					</div>
					<div class="flex flex-col justify-between">
						<li class="wow animate__animated animate__fadeInUp">{{ info.gzh.name }}</li>
						<img class="wow animate__animated animate__fadeInUp" :src="info.gzh.img" alt="">
					</div>
				</div>
			</div>
			<div class="xsForm">
				<el-form ref="ruleFormRef" style="width: 590px" :model="ruleForm" :rules="rules" label-width="left"
					...
					<el-form-item prop="company">
						<template #label>
							<div class="wow animate__animated animate__fadeInUp">企业姓名</div>
						</template>
...
const info = {
	...
	wx: {
		name: '官方微信二维码',
		img: '/public/aboutUs/wx.png'
	},
	gzh: {
		name: '微信公众号二维码',
		img: '/public/aboutUs/gzh.png'
	}
}
