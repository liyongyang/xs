      ...
      <div class="text-center">
        ...
        <el-form ref="ruleFormRef" :model="userForm" label-width="left">
          ...
          <el-form-item prop="company">
            ...
            <el-input :disabled="showKey === 'delete'" v-model="userForm.pwd" />
          </el-form-item>
...
const commit = () => {
  console.log(`output->showKey.value`, showKey.value);
  switch (showKey.value) {
    case "add":
      ...
      break;
    case "edit":
      sys.editUser(userForm).subscribe((res) => {
        ElMessage({
          message: "已成功" + showTitle.value,
          center: true,
          offset: 80,
  ...
  userForm.name = "";
  userForm.pwd = "";
  console.log(`output->userForm`, userForm);
  getMsgList();
};
