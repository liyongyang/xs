	...
	<div class="pg-container">
		...
		<section class="section-banner">
			...
			<div ref="gdRef" class="pg1_frame-wrapper panel center column gradient-blue text-dark" @wheel="handleScroll">
				<div class="pg1_frame-text-wrapper wow animate__animated animate__fadeInUp" v-show="showGd">
				...
				<div ref="gdRef2" class="pg1_frame-text-wrapper2 text-center" v-show="showGd2">
